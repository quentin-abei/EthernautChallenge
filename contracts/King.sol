 ...
 *  On such an event, the overthrown king gets paid 
 * the new prize, making a bit of ether in the process!
 *  As ponzi as it gets xD
 * Such a fun game. Your goal is to break it.
 * When you submit the instance back to the level,
 * the level is going to reclaim kingship. 
 * You will beat the level if you can avoid 
 * such a self proclamation.
 */

// 0x60B774330645846d0Dad2E5587aDec5CcAbed1BE
contract King {
